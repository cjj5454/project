...
class DemoEtid2Table extends Component {
...
this.props.MultiInit.getMultiLang({moduleId: 'CH010105', domainName: 'asdf',callback})
}
...
<div className="nc-single-table">
    ...
    <div className="header-title-search-area">
        {createBillHeadInfo(
        {
        title: this.state.json['CH010105-000018']/* 国际化处理： 国家地区*/,
        backBtnClick:()=>{},
...
ReactDOM.render(<DemoEtid2Table />, document.querySelector('#app'));
